...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { email: @donor.email, first_name: @donor.first_name, last_name: @donor.last_name, phone: @donor.phone } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { email: @donor.email, first_name: @donor.first_name, last_name: @donor.last_name, phone: @donor.phone } }
